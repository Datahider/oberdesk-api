...
class InputGET extends AbstractInput {
    ...
    public function process() {
        ...
        if (is_a('losthost\\OberdeskAPI\\functions\\get\\'. $function, AbstractFunctionImplementation::class, true)) {
            $handler = new ('losthost\\OberdeskAPI\\functions\\get\\'. $function)();
